...
Usage:
  python scripts/validate_job.py path/to/job.yml
  python scripts/validate_job.py path/to/job.yml --schema pdf2audio/data/job.schema.json
"""
...
def main() -> int:
    ...
    if args.schema:
        ...
        schema_path = Path(__file__).resolve().parent.parent / "pdf2audio" / "data" / "job.schema.json"
